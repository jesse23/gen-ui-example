...
const componentImportMap: Record<string, ComponentDefinition> = {
  ExistWhen: {
    ...
    load: () => import('../components/ExistWhen'),
  ...
  Button: {
    ...
    // @ts-ignore - Dynamic import of TSX file, resolved at runtime by Vite
    load: () => import('../components/DeclButton'),
  ...
  Card: {
    ...
    // @ts-ignore - Dynamic import of TSX file, resolved at runtime by Vite
    load: () => import('../components/DeclCard'),
  ...
  Label: {
    ...
    // @ts-ignore - Dynamic import of TSX file, resolved at runtime by Vite
    load: () => import('../components/DeclLabel')
  },
  Form: {
    name: 'Form',
    ...
    // @ts-ignore - Dynamic import of TSX file, resolved at runtime by Vite
    load: () => import('../components/DeclForm'),
